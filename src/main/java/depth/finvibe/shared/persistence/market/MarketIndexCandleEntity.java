...
@Entity
@Table(
        name = "market_index_candles",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_market_index_candles_code_timeframe_at",
                        columnNames = {"index_code", "timeframe", "candle_at"}
                )
        }
)
public class MarketIndexCandleEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "index_candle_id", nullable = false)
    private Long indexCandleId;
    ...
    public Long getIndexCandleId() { return indexCandleId; }
    public void setIndexCandleId(Long indexCandleId) { this.indexCandleId = indexCandleId; }
